...
<p>
    <a href="api/courses/2013/42">Courses Week 42</a>
</p>
<p>
    <a href="api/students/2013/42">Students Week 42</a>
</p>
...
<form enctype="multipart/form-data" method="post" action="api/students/create">
    ...
    --%>
    <label for="courseInstanceId">courseInstanceId</label> <input type="text" id="courseInstanceId"
                                                                  name="courseInstanceId"><br/>
